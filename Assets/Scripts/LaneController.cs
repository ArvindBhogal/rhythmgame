...
public class LaneController : MonoBehaviour
{
    ...
    public Vector3 SpawnPosition
    {
        get
        {
            return new Vector3(transform.position.x, spawnY, 900);
        }
    }
    ...
    int GetSpawnSampleOffset()
    {
        ...
        double spawnSecsToTarget = (double)spawnDistToTarget / (double)gameManager.noteSpeed;
        
        // Figure out the samples to the target.
        return (int)(spawnSecsToTarget * gameManager.SampleRate);
    }
    ...
    void CheckSpawnNext()
    {
        ...
        int currentTime = gameManager.DelayedSampleTime;
                ...
                laneEvents[pendingEventIdx].StartSample < currentTime + samplesToTarget)
        {
            ...
            NoteObject newObj = gameManager.GetFreshNoteObject();
            newObj.Initialize(evt, this, gameManager);
